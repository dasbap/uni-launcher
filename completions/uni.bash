_uni() {
  ...
  COMPREPLY=( $(compgen -W "--help --list --foreground --dry-run --verbose --add-runner --remove-runner --add-game --add-emu-game --link --unlink --remove-game --set-emu doctor --install --update --system --with-installer --with-emu --all --clear-config $runners $games" -- "$cur") )
}
complete -F _uni uni
